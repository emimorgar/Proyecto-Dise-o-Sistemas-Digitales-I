...
HD_PWD='C:/Users/dell/Documents/SysG/ALU/ALU.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Vectorial_ALU.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Vectorial_ALU.tcl
